class Rooms {
    ...
    createRoom(data) {
        ...
        this.Lider.on("success", res => {
            ...
            if (document.cookie != "") {
                if (document.cookie.split("=")[1].split("")[4] == "L") {
                    if (document.cookie.substring(10) == "4R")
                        siteL.liderChoice()
                    else if (document.cookie.substring(10) == "RST")
                        siteL.raportRST()
                    else if (document.cookie.substring(10) == "RYN")
                        siteL.tNChoice()
                    else if (document.cookie.substring(10) == "RRYN")
                        this.yesNoEventResult()
                    else if (document.cookie.substring(10) == "ROF")
                        siteL.numberChoose()
                    ...
                    else if (document.cookie.substring(10) == "RCB")
                        siteL.checkbox()
    ...
    checkboxEventResult(){
        this.Lider.emit("checkboxEventResult")
